...
def train_custom_dt():
    ...
    if answer == 'y' or answer == 'Y':  
        ...
        test_report.to_csv("results/custom_DT/test_classification_report.csv")
        train_report.to_csv("results/custom_DT/train_classification_report.csv")
    ...
    if answer == 'y' or answer == 'Y':  
        ...
        plt.savefig("results/custom_DT/confusion_matrix.png")
        plt.show()
